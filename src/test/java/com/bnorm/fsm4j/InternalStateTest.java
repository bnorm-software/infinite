...
public class InternalStateTest {
    ...
    public void testTransitions() {
        ...
        transition = new TransitionBase<>(parent.getState(), parent.getState());
        ...
        transition = new TransitionBase<>(parent.getState(), grandparent.getState());
        ...
        transition = new TransitionBase<>(grandchild4_1.getState(), grandparent.getState());
        ...
        transition = new TransitionBase<>(grandparent.getState(), parent.getState());
        ...
        transition = new TransitionBase<>(grandparent.getState(), grandchild2_1.getState());
        ...
        transition = new TransitionBase<>("", grandchild1_1.getState());
